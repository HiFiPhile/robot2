...
/*********************************************************************
*
*     Chip and compiler specifics for ST STM8
*
**********************************************************************
*/

#include <string.h>                    /* for memset and co.        */
...
#define OS_BIG_ENDIAN             (1)       /* STM8 is big endian always */
#define OS_GetTime()              (OS_GetTimeSTM8())
#define OS_SADDR                  __tiny          /* for efficiency placed into the first 256 bytes of RAM */
#define OS_STACKPTR               __near          /* Stack pointer points to near memory, regardless the data model */
#define OS_STACK_ADR              unsigned short  /* The stack kann be addressed in the first 64K of RAM, 16bit address */

#define OS_SWITCH_FROM_INT_MODIFIES_STACK   (0)
#define OS_INTERRUPTS_ARE_NESTABLE_ON_ENTRY (0)

#define OS_TIME                   signed short    /* Default size of "time" paramter is 16 bit signed */

/*  Separate Int stack currently not supported for STM8 */
...
#define OS_ALIGN_PTR              (0)   /* Alignment of pointer not required */
#define OS_ALIGN_INT              (0)   /* Alignment of interger variables not required */

/*****  End of configuration settings *******************************/

#define OS_STAT           unsigned
#define OS_PRIO           unsigned
#define OS_FAST_SCHEDULE  (1)

/****** Enable / Disable interrupts *********************************/
/*      Use intrinsics. We don't support priorities *****************/
...
__monitor OS_TIME OS_GetTimeSTM8(void);  /* Ensure atomic oparation, 8 bit CPU */
...
*  IAR supports 16 virtual registers in memory. b0..b7 are scratch
*/
typedef struct {
  OS_U16  Counters;
  OS_U8   b15;
...
#define OS_VERSION_GENERIC (38609)       /*   Generic version 3.86i */
